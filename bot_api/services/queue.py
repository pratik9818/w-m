...
async def enqueue_generation(business_id: uuid.UUID, trigger: str = "create") -> None:
    ...
    await pool.enqueue_job("run_generation_pipeline", str(business_id), trigger, _job_id=job_id)
